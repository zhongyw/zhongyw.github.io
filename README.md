...
###[View Live zhongyw Blog &rarr;](http://zhongyw.github.io)

![](http://zhongyw.github.io/img/blog-desktop.jpg)
...
```
$ git clone git@github.com:zhongywpro/zywblog-boilerplate.git
```

**[View Boilerplate Here &rarr;](http://zhongyw.github.io/zywblog-boilerplate/)**


## Translation

 - ![cn](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **Chinese (Simplified)**: 感谢 [@BrucZhaoR](https://github.com/BruceZhaoR) 的 [中文翻译 &rarr;](https://github.com/zhongywpro/zhongyw.github.io/blob/master/README.zh.md)
...
- Fixed [issue#15](https://github.com/zhongywpro/zhongyw.github.io/issues/15) about code wrap.
...
<img src="http://zhongyw.github.io/img/blog-md-navbar.gif" width="320" />
...
```
# Site settings
title: zhongyw Blog             # title of your website
SEOTitle: zhongyw Blog			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: zhongyw     # modify this account to yours
weibo_username: zhongyw      # the footer woule be auto-updated.
...
![](http://zhongyw.github.io/img/blog-sidebar.jpg)
...
sidebar-avatar: /img/avatar-zyw.jpg     # use absolute URL.
```
...
![](http://zhongyw.github.io/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://zhongyw.github.io/js-module-7day/"
---
```
...
Change header images of any pages or any posts is pretty easy as mentioned above. But, thanks to [issue #6 (in Chinese)](https://github.com/zhongywpro/zhongyw.github.io/issues/6) asked, **how to make it looks great?**
...
It's possible that you want the two things different. For me, my site-title is **“zhongyw Blog”** but I want the title shows in search engine is **“黄玄的博客 | zhongyw Blog”** which is multi-language.
